...
class CustomParser:
    def __init__(self):
        ...
        self.parser.add_argument('--latent_dim', type=int, default=100) #DEFAULT 100
        ...
        self.parser.add_argument('--dataset_location', type=str, default="C:\\Users\\usman\\Documents\\GitHub\\GAN_AI\\gan_project_students-master\\Anime_faces\\Class")
